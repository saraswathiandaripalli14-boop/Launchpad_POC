...
#2nd this if execute and load all the documents and it will goto document_loader file and 
...
if query:
    ...
    # 6th when user enters a question then it will search the policy type and select that policy type only remaning policy ignore 
    if "leave" in q:
